/**
 * Name: frontend-storage-optimize
 * Description: provide an optimized frontend data window.storage(cache) way.
 * Version: 0.0.1
 * Author: tison <mail@tangshuang.net>
 * Source code: https://github.com/tangshuang/frontend-storage-optimize
 */
...
(function(factory){
    ...
    var prefix = 'frontend-storage-optimize-';

    function store(storage) {
        function factory(name,value,expires) {
            name = md5(prefix + name);
            // get
            if(value === undefined) {
    ...
    var objectStore = {
        ...
        setItem : function(name,value) {
            objectStorage[name] = value;
        },
        removeItem : function(name) {
            delete objectStorage[name];
        }
    };
    ...
    return {
        ...
        object : store(objectStore) // store data in a object, which will be cleaned when refresh
    };
});
